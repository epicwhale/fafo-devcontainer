...
devcontainer exec zsh -c 'zsh --version && claude --version && agy --version && codex --version && opencode --version && skills --version && node --version && gh --version && docker --version && tmux -V && zellij --version'
